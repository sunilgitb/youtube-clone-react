...
const Library = () => {
    ...
    return ( 
        ...
        >
            ...
            <h1 className='text-[25px] font-normal text-center px-2'>Enjoy your favorite videos</h1>
            <p className='text-[15px] text-center px-2'>Sign in to access videos that you’ve liked or saved</p>
