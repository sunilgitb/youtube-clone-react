...
const Subscriptions = () => {
    ...
    return ( 
        ...
        >
            ...
            <h1 className='text-[25px] font-normal text-center px-2'>Don’t miss new videos</h1>
            <p className='text-[15px] text-center px-2'>Sign in to see updates from your favorite YouTube channels</p>
